...
part biosboot --fstype=biosboot --size=500
...
# MACBOOK 14,1 PACKAGES
kernel-4*mk_kernel*
kernel-core-*mk_kernel*
kernel-devel-*mk_kernel*
kernel-modules-*mk_kernel*
kernel-modules-extra-*mk_kernel*
kmod
dkms
git
gcc
...
echo PENIS PENIS PENIS
# LIVECD-CREATOR IS FUCKED
#cp $INSTALL_ROOT/boot/initramfs-*mk_kernel*.img $LIVE_ROOT/isolinux/initrd0.img
#cp $INSTALL_ROOT/boot/vmlinuz-*mk_kernel* $LIVE_ROOT/isolinux/vmlinuz0

#cp /boot/initramfs-*mk_kernel*.img /isolinux/initrd0.img
#cp /boot/vmlinuz-*mk_kernel* /isolinux/vmlinuz0
%end
