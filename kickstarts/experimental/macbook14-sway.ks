...
services --disabled=kdm,lxdm,lightdm,xdm --enabled=sddm
...
# live system needs these
anaconda-runtime
plymouth-system-theme

# Everyone loves some PCP in their system
# WTF is it? We have selinux labels for "pcp" and livecd-creator
# bombs without it.
pcp-selinux
