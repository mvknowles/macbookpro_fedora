...
# This script will build a Live Fedora 30 Workstation ISO image that will
...
#MAIN_KS=fedora-live-minimization.ks
...
EXTRAS[2]=kickstarts/macbook_mate.ks
EXTRAS[3]=kickstarts/macbook_sway.ks
...
livecd-creator --config="macbook_sway.ks" --fslabel=fc29_mbp14_mate --releasever=29 --tmpdir=${TMP_DIR} --cache=${CACHE_DIR} -d -v --logfile=livecd_log.txt ${CACHE_OPT} ${SHELL_OPT}
